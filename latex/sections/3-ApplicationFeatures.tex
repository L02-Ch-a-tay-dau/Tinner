...
\begin{itemize}
    ...
    \item \textbf{Khớp nhóm và Gamification (Group Match and Gamification):} Các tính năng như "Khớp nhóm" (khớp chỉ xảy ra khi mọi người trong nhóm cùng vuốt sang phải) và "Vòng quay may mắn" được thiết kế để giải quyết các xung đột ăn uống trong nhóm và biến việc chọn nhà hàng thành một trò chơi xã hội thú vị.
